#!/usr/bin/env node
/**
 * The `federal-mcps-census` bin target (`package.json` `bin`).
 *
 * This file is static and committed with its executable bit set in git, so
 * `npx federal-mcps-census` and `node_modules/.bin/federal-mcps-census` work no
 ...
 * file, makes `npx federal-mcps-census` work after either build path.
 */
