#!/usr/bin/env node
/**
 * The `federal-mcps-bls` bin target (`package.json` `bin`).
 *
 * This file is static and committed with its executable bit set in git, so
 * `npx federal-mcps-bls` and `node_modules/.bin/federal-mcps-bls` work no
 ...
 * file, makes `npx federal-mcps-bls` work after either build path.
 */
