 ...
 * its definitions here, not by touching the tool. All seven BLS programs are wired: LAUS, CES, CPI,
 * OEWS, JOLTS, PPI (timeseries API; PPI national-only) and QCEW (its own CSV client via the fetch
 * capability).
 */
