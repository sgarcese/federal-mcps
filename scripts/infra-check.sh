...
roots=(terraform/modules/bls-server terraform/modules/geo-server terraform/modules/census-server terraform/modules/opencontext-portal terraform/instances/dev)
...
for root in terraform/modules/bls-server terraform/modules/geo-server terraform/modules/census-server terraform/modules/opencontext-portal terraform/instances/dev; do
