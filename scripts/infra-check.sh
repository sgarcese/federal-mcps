...
roots=(terraform/bootstrap terraform/modules/github-oidc-deploy-role terraform/instances/dev)
...
for root in terraform/modules/github-oidc-deploy-role terraform/instances/dev; do
